(() => {
  ...
  const injectStyles = () => {
    ...
    style.textContent = `
      .admin-panel{position:fixed;bottom:24px;left:24px;width:320px;max-width:92vw;background:rgba(45,26,26,0.94);color:#ffe8e8;border:1px solid rgba(249,115,22,0.4);border-radius:16px;padding:18px;box-shadow:0 18px 38px rgba(0,0,0,0.4);z-index:9999;font-family:'Inter','Segoe UI',sans-serif;backdrop-filter:blur(12px);}
      ...
      .admin-panel__input{flex:1 1 140px;padding:10px 12px;border-radius:10px;border:1px solid rgba(249,115,22,0.5);background:rgba(20,12,12,0.85);color:#ffe8e8;font-size:14px;}
      .admin-panel__btn{padding:10px 14px;border-radius:10px;border:none;background:linear-gradient(135deg,#f97316,#ea580c);color:#fff7ed;font-weight:600;cursor:pointer;transition:transform .15s ease, box-shadow .15s ease;}
      .admin-panel__btn:hover{transform:translateY(-1px);box-shadow:0 12px 20px rgba(249,115,22,0.35);}
      .admin-panel__btn--ghost{background:rgba(249,115,22,0.16);color:#ffe8e8;}
      .admin-panel__btn--ghost:hover{box-shadow:0 12px 20px rgba(249,115,22,0.25);}
      .admin-panel__hint{font-size:13px;color:#ffb3b3;margin:0;}
      .admin-panel__status{font-size:13px;color:#fb923c;margin:0;}
      .admin-panel__section--meta{font-size:13px;color:#ffb3b3;}
      .admin-panel__section--meta button{width:100%;}
      .admin-wa-target{outline:1px dashed rgba(249,115,22,0.6);outline-offset:4px;position:relative;}
      .admin-wa-target::after{content:'WA';position:absolute;top:-10px;right:-10px;font-size:11px;background:rgba(249,115,22,0.85);color:#fff7ed;padding:2px 6px;border-radius:999px;}
